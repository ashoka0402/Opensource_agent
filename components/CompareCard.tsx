...
// Mock GitHub profile data for NiladriHazra (updated with real data)
const mockGitHubUser: GitHubUser = {
  ...
  public_repos: 19,
  location: "Kolkata",
  bio: "Here to learn ! 🎯 Focusing",
  created_at: "2023-07-01T10:30:00Z",
  company: null,
  blog: "https://niladri.tech"
};
  ...
  topRepos: [
    {
      ...
      description: "A beautiful code visualization and sharing platform",
      stars: 3,
      forks: 0,
      language: "TypeScript",
    ...
    {
      name: "ECL_Hospitals",
      description: "Hospital management system with modern UI",
      stars: 2,
      forks: 0,
      language: "TypeScript",
      url: "https://github.com/NiladriHazra/ECL_Hospitals",
      commitCount: 67,
      daysSinceUpdate: 5
    }
  ],
